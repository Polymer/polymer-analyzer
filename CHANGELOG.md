...
* [BREAKING] All methods on Package no longer return results from external code. Added a queryOptions param to all query methods to allow asking for results from imported external code.
