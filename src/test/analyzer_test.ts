...
import {Document, Element, Import} from '../model/model';
// import {Document, Element, Import, ScannedImport, ScannedInlineDocument} from '../model/model';
...
suite('Analyzer', () => {
  ...
  suite('analyze()', () => {
    ...
    test.only(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/analysis/simple/simple-element.html') as Document;
    ...
    test(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/analysis/separate-js/element.html') as Document;
          assert.instanceOf(document, Document);
          const elements = Array.from(document.getByKind('element'));
    ...
    test('analyzes a document with an import', async() => {
      const document =
          await analyzer.analyze('static/analysis/behaviors/behavior.html') as Document;
      assert.instanceOf(document, Document);
    ...
    test(
        ...
        async() => {
          const document =
              await analyzer.analyze('static/html-missing-behaviors.html') as Document;
    ...
    test(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/chained-missing-behavior/index.html') as Document;
    ...
    test(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/script-tags/inline/test-element.html') as Document;
    ...
    test(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/script-tags/external/test-element.html') as Document;
    ...
    test(
        ...
        async() => {
          const document = await analyzer.analyze(
              'static/analysis/behaviors/elementdir/element.html') as Document;
    ...
    test('returns a Document with warnings for malformed files', async() => {
      const document = await analyzer.analyze('static/malformed.html') as Document;
      assert(document.getWarnings().length >= 1);
    });

    test('analyzes transitive dependencies', async() => {
      const root = await analyzer.analyze('static/dependencies/root.html') as Document;
    ...
    test('handles mutually recursive documents', async() => {
      const document = await analyzer.analyze('static/circular/mutual-a.html') as Document;
    ...
    test('handles a document importing itself', async() => {
      const document =
          await analyzer.analyze('static/circular/self-import.html') as Document;
  ...
  suite('legacy tests', () => {
    ...
    test.skip('parses classes', async() => {
      const document = await analyzer.analyze('static/es6-support.js') as Document;
